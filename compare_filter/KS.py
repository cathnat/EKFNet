...
def kalman_denoising(signal, Q=1e-5, R=0.1):
    """
...
denoised_signal = kalman_denoising(observations)

def loss(states,denoised_signal):
    denoised = kalman_denoising(denoised_signal)
...
np.save('../result/hh1/KS_denoise.npy', denoised_signal)